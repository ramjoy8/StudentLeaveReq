...
include_once("connection.php");
 ...
 $sql = "SELECT image FROM faculty WHERE empid='$empid'";
...
<tr>
  ...
  <tr>
    <td style="padding-left: 30px;"><font color=#FFFFFF><b>EMP ID. :</b></font></td>
    <td><font color=#FFFFFF><b><?php echo $empid ?></b></font></td>
</tr>
<tr>
...
<ul>
  <li><a href="leaveappro.php" ><font size=5 color=#FFFFFF face="Comic Sans MS">Student Leave Request</a></li>
   <li><a href="flogout.php" ><font size=5 color=#FFFFFF face="Comic Sans MS">Log Out</a></li>
