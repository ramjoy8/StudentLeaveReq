...
<tr>
  <td align=center>
      <img src="images/73.gif" height="70" width="200">
    </td>
...
$sql = "SELECT id,leavestatus,facultyid,studentname,parentstatus,studentid,leavetype,fromdate,todate,address,reason FROM leavereq WHERE facultyid='$empid'";
...
<td align ="center"><a href="approve.php?id='.$row['id'].'"><img src="images/approval.jpg" alt="Approve" width="95" height="30"/></a> 
<a href="decline.php?id='.$row['id'].'"><img src="images/decline.jpg" alt="Decline" width="95" height="30"/></a></td>
</tr> ';
...
<td align ="center">'.$row['leavetype'].'</td>
 ...
 <td align ="center">'.$row['reason'].'</td>
  ...
  <td style="padding-right= 5px;">
<a ><img src="images/ack.png" alt ="ack" width="70" height="60"/></a>
...
echo '  <table><tr > 
<td align = "center"><form method="post" action="leaveappro.php">
