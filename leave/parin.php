...
include_once("connection.php");
 ...
 $sql = "SELECT name,image FROM student WHERE regno='$regno'";
...
<tr>
  ...
  <tr>
    <td style="padding-left: 30px;"><font color=#FFFFFF><b>Student Reg no.:</b></font></td>
    <td><font color=#FFFFFF><b><?php echo $regno ?></b></font></td>
</tr>
<tr>
    <td style="padding-left: 30px;"><font color=#FFFFFF><b>Student Name :</b></font></td>
    <td><font color=#FFFFFF><b><?php echo $row['name'] ?></b></font></td>
</tr>
</table>
</td>
</tr>
...
<ul>
  <li><a href="leaveack.php" ><font size=5 color=#FFFFFF face="Comic Sans MS">Student Leave Request</a></li>
  <li><a href="plogout.php" ><font size=5 color=#FFFFFF face="Comic Sans MS">Log Out</a></li>
