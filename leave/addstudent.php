...
if (!isset($_FILES['image']['tmp_name']))
 {
	...
	$image_name= addslashes($_FILES['image']['name']);
			...
			$sql="INSERT INTO student (regno,name,password,image,bday) VALUES ('$studentid','$name','$password','$location','$bday')";
...
<td><font color=#FFFFFF><b> Student Register No :</b></font>
   ...
   <tr>   
<td><font color=#FFFFFF><b> Student Name :</b></font>
</td>
  ...
  <tr >
<td><font color=#FFFFFF><b> Student Image :</b></font></td>
<td>	<input type="file" name="image" class="ed"></td>
</tr>
  <tr>   
<td><font color=#FFFFFF><b> Student BirthDay :</b></font>
</td>
...
<form name="dd" method="post" action="addstudent.php">
