...
<td><font color=#FFFFFF><b>Faculty ID :</b></font>
     ...
     <td><input type="text" name="empid" class="textinput"></td> 
</tr>  
  <tr>
...
<td style="background-color: rgb(12, 47, 77)" align="center" width="4%">
    ...
    <li><a href="#" onclick="popup2('http://vtop2.vit.ac.in:8080/ONLINEPAYMENT/')"><font color=blue><b> CAT-II invizilation Schedule  .</b></font></a></li>
    <li><a href="#" onclick="popup2('https://academics.vit.ac.in/studentprofile/fresher_passwd.asp')"><font color=blue><b>"Faculty Login"</b> Password (Only for New Entry).</font></a></li><br>
